<?php
 /**
  * @version   $Id: compositeoverrides.php 5150 2012-11-13 20:29:46Z josh $
...
class GantryFeatureCompositeOverrides extends GantryFeature {
	...
	function init() {
        ...
        if (defined('ROKCOMMON') && class_exists('RokCommon_Composite')){
            RokCommon_Composite::addPackagePath('mod_rokgallery', JPATH_SITE . '/templates/rt_cerulean/overrides/mod_rokgallery/templates',20);
        }
	}
