<?php
/**
* @version   $Id: styledeclaration.php 9994 2013-05-02 13:37:35Z kat $
...
class GantryFeatureStyleDeclaration extends GantryFeature {
    ...
    function buildBackground(){
        ...
        if (!$gantry->get('headerimage-enabled') && ($gantry->browser->platform != 'iphone')) return "";

        $source = $width = $height = "";

        $background = str_replace("&quot;", '"', str_replace("'", '"', $gantry->get('headerimage-image')));
        ...
        $output .= "#rt-bg-image {position: absolute;max-width: 100%;width: ".$width."px;height: ".$height."px;top: 0;}"."\n";
